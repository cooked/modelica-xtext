 ...
 * </p>
 * <ul>
 *   <li>{@link sc.modelica.xtext.modelicaMo.impl.ImportListImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImportListImpl extends MinimalEObjectImpl.Container implements ImportList
{
  ...
  {
    return ModelicaMoPackage.Literals.IMPORT_LIST;
  }
  ...
  public EList<String> getId()
  {
    if (id == null)
    {
      id = new EDataTypeEList<String>(String.class, this, ModelicaMoPackage.IMPORT_LIST__ID);
    }
    return id;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ModelicaMoPackage.IMPORT_LIST__ID:
        return getId();
    }
